  ...
  return (
    <div className="main-left">
                  ...
                  <li>
                    <div className="star-above">
                      <label>
                        ...
                        <div className="four-stars">4★ &amp; above</div>
                        <br></br>
                        <input type="checkbox"></input> <div className="four-stars">3★ &amp; above</div>
                        <br></br>
                        <input type="checkbox"></input> <div className="four-stars">2★ &amp; above</div>
                        <br></br>
                        <input type="checkbox"></input> <div className="four-stars">1★ &amp; above</div>
                        <br></br>
                      </label>
                    </div>{" "}
                  </li>
      ...
      <div className="mainleft-img">
        ...
        <div className="help">
          <span>
            Help Me decide <MdOutlineKeyboardArrowRight />
          </span>
        </div>
        <div>
          <img src={buying} alt="" />{" "}
